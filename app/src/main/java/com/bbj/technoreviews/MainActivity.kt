...
import com.bbj.technoreviews.util.DNSParserV1
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        kotlinx.coroutines.GlobalScope.launch(Dispatchers.Default) {
            ...
            val result2 = DNSParserV1.getResult("vivo hp2033") as ResultStates.Success
            val timeEnd = System.currentTimeMillis() - timeStart
            Log.d("MAIN","Time tag = $timeEnd")
            val timeStart1 = System.currentTimeMillis()
            val result = DNSParser.getResult("vivo hp2033") as ResultStates.Success
